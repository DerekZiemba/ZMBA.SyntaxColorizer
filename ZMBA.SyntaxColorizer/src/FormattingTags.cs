...
namespace ZMBA.SyntaxColorizer {
  ...
  internal class FormattingTags {
    ...
    internal ClassificationTag SyntaxKeywordControl { get; }
    internal ClassificationTag SyntaxOperator { get; }
    internal ClassificationTag SyntaxOperatorOverloaded { get; }
    ...
    internal FormattingTags(IClassificationTypeRegistryService registry) {
      ...
      this.SyntaxKeywordControl = new ClassificationTag(registry.GetClassificationType(FormatDefinitions.Syntax.KeyWord.Control.Key));

      this.SyntaxOperator = new ClassificationTag(registry.GetClassificationType(FormatDefinitions.Syntax.Operator.Key));
      this.SyntaxOperatorOverloaded = new ClassificationTag(registry.GetClassificationType(FormatDefinitions.Syntax.Operator.Overloaded.Key));
