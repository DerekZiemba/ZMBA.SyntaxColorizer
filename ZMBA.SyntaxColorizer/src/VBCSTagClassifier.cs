...
#pragma warning restore CS0067 // The event is never used
			...
			if(node != null) {
				switch(node.RawKind) {
					...
					default:
						...
						if(rawsymbol != null) {
							switch(rawsymbol.Kind) {
								case SymbolKind.Field: return ClassifyIdentifier_Field(ctx, ref span, node, (IFieldSymbol)rawsymbol);
								case SymbolKind.Method: return ClassifyIdentifier_Method(ctx, ref span, node, (IMethodSymbol)rawsymbol); 
								case SymbolKind.NamedType: return ClassifyIdentifier_NamedType(ctx, ref span, node, (INamedTypeSymbol)rawsymbol); 
								case SymbolKind.Local: return ClassifyIdentifier_Local(ctx, ref span, node, (ILocalSymbol)rawsymbol); 
								...
								case SymbolKind.Property: return ClassifyIdentifier_Property(ctx, ref span, node, (IPropertySymbol)rawsymbol);
    ...
    private TagSpan<ClassificationTag> ClassifyIdentifier_Field<T> (ClassifierContext ctx, ref ClassifiedSpan span, SyntaxNode node, T symbol) where T: IFieldSymbol {
    ...
    [MethodImpl(256 | 512)] //[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private TagSpan<ClassificationTag> ClassifyIdentifier_Property<T> (ClassifierContext ctx, ref ClassifiedSpan span, SyntaxNode node, T symbol) where T: IPropertySymbol {
    ...
    [MethodImpl(256 | 512)] //[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private TagSpan<ClassificationTag> ClassifyIdentifier_NamedType<T> (ClassifierContext ctx, ref ClassifiedSpan span, SyntaxNode node, T symbol) where T: INamedTypeSymbol {
    ...
    [MethodImpl(256 | 512)] //[MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private TagSpan<ClassificationTag> ClassifyIdentifier_Local<T> (ClassifierContext ctx, ref ClassifiedSpan span, SyntaxNode node, T symbol) where T: ILocalSymbol {
      if(symbol.IsConst) {
        return Tags.IdentifierConst.Associate(ctx.SnapShot, span.TextSpan);
      } else {
